...
function initFAQ() {
	...
	function generateFAQContent(category) {
		...
		title.className =
			"text-2xl font-bold mb-8 pb-2 border-b dark:border-gray-700 dark:text-white";
		...
		categoryData.items.forEach((item, index) => {
			...
			icon.className =
				"faq-icon flex-shrink-0 ml-4 text-primary transition-transform duration-300";
			icon.innerHTML = `
           ...
           `;
			...
			answer.className =
				"faq-answer px-6 pb-6 text-gray-500 dark:text-gray-300";
